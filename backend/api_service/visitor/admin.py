...
class VisitorKYCResource(resources.ModelResource):
    class Meta:
        model = VisitorKYC

class VisitorsMessageResource(resources.ModelResource):
    class Meta:
...
class VisitorKYCAdmin(ExportMixin, admin.ModelAdmin):
